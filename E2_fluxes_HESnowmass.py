...
#             legends.append(best_fit_3s)
        ...
        first_legend = plt.legend(handles=legends, loc='lower left', fontsize=legendfontsize, handlelength=4)
...
#                     horizontalalignment='left', color='saddlebrown', rotation=40, fontsize=legendfontsize)
    ...
    if show_anita_I_IV_limit:
        ax.plot(anita_i_iv_limit[:, 0] / plotUnitsEnergy, anita_i_iv_limit[:, 1] / plotUnitsFlux, color='#FC8A48', linewidth=4)
        if energyBinsPerDecade == 2:
            ...
            ax.annotate('ANITA I-IV',
                        xy=(1.5e20 * units.eV / plotUnitsEnergy, 1.2e-7* 3.0 * flavorRatio), xycoords='data',
    ...
    if show_ice_cube_EHE_limit:
        ax.plot(ice_cube_limit[2:, 0] / plotUnitsEnergy, ice_cube_limit[2:, 1] / plotUnitsFlux * flavorRatio, color='#5CACE2', linewidth=4)
    ...
    if show_ice_cube_HESE_fit:
        ...
        ax.fill_between(IC_Cascades2020_en / plotUnitsEnergy, *IC_Cascades2020_flux, edgecolor='#5CACE2', facecolor='azure', alpha=0.7, zorder=2)
        ...
        if energyBinsPerDecade == 2:
            ...
            ax.annotate('IceCube',
                    xy=(5e15 * units.eV / plotUnitsEnergy, 5e-9 * 3.0 * flavorRatio), xycoords='data',
                    horizontalalignment='center', color='#5CACE2', rotation=0, fontsize=labelfontsize)
    if show_ice_cube_mu:
        # mu fit
    ...
    if show_auger_limit:
        augerleg, = ax.plot(auger_limit[:, 0] / plotUnitsEnergy, auger_limit[:, 1] / plotUnitsFlux, color='#269788', linewidth=4)
        if energyBinsPerDecade == 2:
            ax.annotate('Auger',
            ...
            ax.annotate('Auger',
                        xy=(4.1e17 * units.eV / plotUnitsEnergy, 1.5e-8* 3.0 * flavorRatio), xycoords='data',
...
#         ax.plot(ara_4year[:,0]/plotUnitsEnergy,ara_4year[:,1]/ plotUnitsFlux,color='indigo',linestyle='--')
        if energyBinsPerDecade == 2:
            ...
            ax.annotate('ARA',
                    ...
                    horizontalalignment='left', color='indigo', rotation=0, fontsize=labelfontsize)
    if show_ara:
        ax.plot(ara_4year_E / plotUnitsEnergy, ara_4year_limit / plotUnitsFlux, color='#E94880', linewidth=4)
#         ax.plot(ara_4year[:,0]/plotUnitsEnergy,ara_4year[:,1]/ plotUnitsFlux,color='indigo',linestyle='--')
        if energyBinsPerDecade == 2:
            ax.annotate('ARA',
            ...
            ax.annotate('ARA',
                    xy=(2e20 * units.eV / plotUnitsEnergy, 0.5e-6* 3.0 * flavorRatio), xycoords='data',
                    horizontalalignment='left', color='#E94880', rotation=0, fontsize=labelfontsize)
    if show_ara_2023:
...
#                     horizontalalignment='left', color='grey', rotation=0, fontsize=legendfontsize)
    ...
    if show_arianna:
        ax.plot(ARIANNA_HRA[:, 0] / plotUnitsEnergy, ARIANNA_HRA[:, 1] / plotUnitsFlux, color='#F48FB1', linewidth=4)
#         ax.plot(ara_4year[:,0]/plotUnitsEnergy,ara_4year[:,1]/ plotUnitsFlux,color='indigo',linestyle='--')
        if energyBinsPerDecade == 2:
            ax.annotate('ARIANNA',
            ...
            ax.annotate('ARIANNA',
                    xy=(3e20 * units.eV / plotUnitsEnergy, 5e-6* 3.0 * flavorRatio), xycoords='data',
